...
export const videos = {
  ...
  'Making money': [
    ...
    { title: '7 side hustle ideas to make $1000/month', author: 'Ali Abdaal', duration: '19 min', youtubeId: 'I-dlPuqFguo' },
  ],
  'Tech & AI': [
  ...
  'Life skills': [
    ...
    { title: 'Your goals are quietly restricting your happiness', author: 'James Clear', duration: '28 min', youtubeId: 'rtufWBLOXgw' },
  ],
};
